...
public class Activator extends AbstractUIPlugin implements IStartup {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "gov.nasa.ensemble.core.plan.editor.constraints";
	...
	public static ImageDescriptor getImageDescriptor(String path) {
		return AbstractUIPlugin.imageDescriptorFromPlugin("gov.nasa.ensemble.core.plan.editor.constraints", path);
	}
