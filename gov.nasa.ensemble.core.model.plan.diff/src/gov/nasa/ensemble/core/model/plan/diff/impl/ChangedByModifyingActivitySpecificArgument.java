...
public class ChangedByModifyingActivitySpecificArgument extends
		AbstractChangedByModifyingParameterImpl implements
		ChangedByModifyingParameter {

	public ChangedByModifyingActivitySpecificArgument(OldAndNewCopyOfSameThing oldAndNew, EStructuralFeature parameter) {
