...
public class DependencyFactoryImpl extends EFactoryImpl implements DependencyFactory {
	...
	public static DependencyFactory init() {
		try {
			DependencyFactory theDependencyFactory = (DependencyFactory)EPackage.Registry.INSTANCE.getEFactory("platform:/resource/gov.nasa.ensemble.core.plan.resources/model/ResourceDependency.ecore"); 
