...
/**
 * This is the item provider adapter for a {@link gov.nasa.ensemble.core.plan.resources.member.Claim} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Claim_used_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Claim_used_feature", "_UI_Claim_type"),
				 MemberPackage.Literals.CLAIM__USED,
				 true,
				 false,
				 false,
