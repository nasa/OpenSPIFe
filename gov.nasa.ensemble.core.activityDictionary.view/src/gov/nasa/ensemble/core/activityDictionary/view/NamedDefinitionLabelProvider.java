...
public class NamedDefinitionLabelProvider extends LabelProvider {

	@Override
	public String getText(Object element) {
		if (element instanceof ENamedElement) {
			String text = DictionaryUtil.getDisplayName((ENamedElement) element);
			if (text != null) {
				return text;
			}
		}
		...
		if (element instanceof INamedDefinition) {
			return ((INamedDefinition)element).getName();
		}
