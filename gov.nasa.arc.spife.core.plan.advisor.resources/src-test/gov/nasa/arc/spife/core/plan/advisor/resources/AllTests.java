...
public class AllTests implements IEnsemblePluginTest {
	...
	public void addTests(TestSuite suite) {
		//$JUnit-BEGIN$
		suite.addTestSuite(TestActivityStateRequirementPlanAdvisor.class);
		suite.addTestSuite(TestActivityNumericRequirementPlanAdvisor.class);
		suite.addTestSuite(TestProfileConstraintPlanAdvisor.class);
		suite.addTestSuite(TestActivityRequirementEnumConstant.class);
		//$JUnit-END$
	}
