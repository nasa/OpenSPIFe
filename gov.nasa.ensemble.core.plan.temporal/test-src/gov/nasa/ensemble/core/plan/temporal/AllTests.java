...
public class AllTests implements IEnsemblePluginTest {
	...
	public void addTests(TestSuite suite) {
		//$JUnit-BEGIN$
		suite.addTestSuite(TestDirectPlanModifier.class);
		suite.addTestSuite(TestTemporalTransferableExtension.class);
//		suite.addTestSuite(TestTemporalBound.class);
		suite.addTestSuite(TestTemporalModifier.class);
		//$JUnit-END$
	}
