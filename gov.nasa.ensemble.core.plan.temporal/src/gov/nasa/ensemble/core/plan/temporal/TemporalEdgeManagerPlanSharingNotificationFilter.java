...
public class TemporalEdgeManagerPlanSharingNotificationFilter extends DisabledPlanSharingNotificationFilter {

	@Override
	public boolean matches(Notification notification) {
		return (notification.getNotifier() instanceof TemporalEdgeManager);
	}
