 ...
 * <ul>
 *   <li>{@link gov.nasa.arc.spife.core.plan.timeline.impl.PlanSectionImpl#getRows <em>Rows</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PlanSectionImpl extends AbstractPlanSectionImpl implements PlanSection {
	/**
	 ...
	 * @ordered
	 */
	protected EList<PlanSectionRow> rows;
	...
	protected EClass eStaticClass() {
		return PlanTimelinePackage.Literals.PLAN_SECTION;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PlanTimelinePackage.PLAN_SECTION__ROWS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case PlanTimelinePackage.PLAN_SECTION__ROWS:
				getRows().clear();
				getRows().addAll((Collection<? extends PlanSectionRow>)newValue);
				return;
		}
