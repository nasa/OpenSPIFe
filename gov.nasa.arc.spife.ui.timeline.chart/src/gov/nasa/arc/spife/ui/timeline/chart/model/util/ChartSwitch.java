...
public class ChartSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ChartPackage.AMOUNT_LINE: {
				AmountLine amountLine = (AmountLine)theEObject;
				T result = caseAmountLine(amountLine);
				if (result == null) result = caseChartElement(amountLine);
			...
			case ChartPackage.CHART: {
				...
				if (result == null) result = caseTimelineContent(chart);
				if (result == null) result = caseSection(chart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ChartPackage.CHART_ELEMENT: {
				ChartElement chartElement = (ChartElement)theEObject;
				T result = caseChartElement(chartElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ChartPackage.CHARTS: {
				Charts charts = (Charts)theEObject;
				T result = caseCharts(charts);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ChartPackage.LINE_CHART: {
				LineChart lineChart = (LineChart)theEObject;
				T result = caseLineChart(lineChart);
				if (result == null) result = caseChart(lineChart);
				if (result == null) result = caseTimelineContent(lineChart);
				if (result == null) result = caseSection(lineChart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ChartPackage.PLOT: {
				Plot plot = (Plot)theEObject;
				T result = casePlot(plot);
				if (result == null) result = caseChartElement(plot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Amount Line</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Amount Line</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAmountLine(AmountLine object) {
		return null;
	}
