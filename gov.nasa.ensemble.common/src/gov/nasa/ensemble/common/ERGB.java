 ...
 * </ul>
 */
public ERGB(int red, int green, int blue) {
	if ((red > 255) || (red < 0) ||
		(green > 255) || (green < 0) ||
		(blue > 255) || (blue < 0))
...
* @since 3.2
*/
public ERGB(float hue, float saturation, float brightness) {
...
public boolean equals(Object object) {
	...
	if (!(object instanceof ERGB)) return false;
	ERGB rgb = (ERGB)object;
