...
public class MergePlanClipboardCutOperation extends PlanClipboardCutOperation {
	...
	public MergePlanClipboardCutOperation(ITransferable transferable, IStructureModifier modifier, ISelectionProvider provider, Tree tree) {
