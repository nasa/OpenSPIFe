...
public class ZoomOutHandler extends ZoomTimelineCommandHandler implements ZoomListener {

	public static final String COMMAND_ID = "gov.nasa.arc.spife.ui.timeline.zoom.out.command";
