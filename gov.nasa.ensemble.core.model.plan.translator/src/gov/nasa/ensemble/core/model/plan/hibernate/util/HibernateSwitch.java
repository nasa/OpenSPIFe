 ...
 * $Id$
 */
package gov.nasa.ensemble.core.model.plan.hibernate.util;
 ...
 * <!-- end-user-doc -->
 * @see gov.nasa.ensemble.core.model.plan.hibernate.HibernatePackage
 * @generated
 */
public class HibernateSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HibernatePackage.HIBERNATE_MEMBER: {
				HibernateMember hibernateMember = (HibernateMember)theEObject;
				T result = caseHibernateMember(hibernateMember);
				if (result == null) result = caseEMember(hibernateMember);
	 ...
	 * @generated
	 */
	public T caseHibernateMember(HibernateMember object) {
		return null;
	}
