...
public class HibernateAdapterFactory extends AdapterFactoryImpl {
	...
	protected HibernateSwitch<Adapter> modelSwitch =
		new HibernateSwitch<Adapter>() {
			@Override
			public Adapter caseHibernateMember(HibernateMember object) {
				return createHibernateMemberAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link gov.nasa.ensemble.core.model.plan.hibernate.HibernateMember <em>Member</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createHibernateMemberAdapter() {
		return null;
	}
