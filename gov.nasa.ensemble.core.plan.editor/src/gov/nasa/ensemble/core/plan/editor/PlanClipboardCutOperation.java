...
public class PlanClipboardCutOperation extends ClipboardCutOperation implements IJobOperation {

	private EPlan context = null;

	public PlanClipboardCutOperation(ITransferable transferable, IStructureModifier modifier) {
