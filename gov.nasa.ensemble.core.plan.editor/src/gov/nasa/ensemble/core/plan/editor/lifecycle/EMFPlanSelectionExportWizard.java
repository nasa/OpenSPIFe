...
public abstract class EMFPlanSelectionExportWizard extends EMFPlanExportWizard {
	@Override
	protected FileSelectionPage createFileSelectionPage() {
		EMFPlanSelectionExportWizardPage page = new EMFPlanSelectionExportWizardPage(SWT.SAVE, getPlan()) {
			@Override
		...
		page.setIncludeSelectionOption(true);
		return page;
	}
