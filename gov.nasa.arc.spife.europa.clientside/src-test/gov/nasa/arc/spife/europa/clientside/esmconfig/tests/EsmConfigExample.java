...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>esmconfig</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EsmConfigExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.esmconfig"));
				DocumentRoot documentRoot = EsmConfigFactory.eINSTANCE.createDocumentRoot();
				EuropaServerType root = EsmConfigFactory.eINSTANCE.createEuropaServerType();
				documentRoot.setEuropaServer(root);
			...
			for (int i = 0; i < args.length; ++i) {
				...
				try {
					...
					//
					//FileUtilities.findFileInPlugin(Activator.getDefault(), "data/test/SolverConfig.xml");
