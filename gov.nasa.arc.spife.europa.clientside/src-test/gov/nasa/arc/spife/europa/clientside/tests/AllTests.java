 ...
 ******************************************************************************/
package gov.nasa.arc.spife.europa.clientside.tests;
...
//		if (product != null) {
//			if ("LASS".equalsIgnoreCase(product.getName())) {
				suite.addTestSuite(gov.nasa.arc.spife.europa.clientside.tests.clientside.TestClientSide.class);
//			}
//		}
		//$JUnit-END$
	}
