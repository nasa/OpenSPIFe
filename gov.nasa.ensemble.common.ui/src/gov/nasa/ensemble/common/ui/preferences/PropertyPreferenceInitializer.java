...
public abstract class PropertyPreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public PropertyPreferenceInitializer(IPreferenceStore store) {
		this.store = store;
	}
	...
	protected final void setBoolean(String prefKey, String propKey, boolean defaultValue) {
		store.setDefault(prefKey, parseBooleanProperty(propKey, defaultValue));
	}
	...
	protected final void setInteger(String prefKey, String propKey, int defaultValue) {
		store.setDefault(prefKey, parseIntegerProperty(propKey, defaultValue));
	}
	...
	protected final void setLong(String prefKey, String propKey, long defaultValue) {
		store.setDefault(prefKey, parseLongProperty(propKey, defaultValue));
	}
	...
	protected final void setDate(String prefKey, String propKey, Date defaultValue) {
		store.setDefault(prefKey, parseDateProperty(propKey, defaultValue));
	}
	...
	protected final void setFloat(String prefKey, String propKey, float defaultValue) {
		store.setDefault(prefKey, parseFloatProperty(propKey, defaultValue));
	}
	...
	protected final void setString(String prefKey, String propKey, String defaultValue) {
		store.setDefault(prefKey, parseStringProperty(propKey, defaultValue));
	}
	...
	protected final void setStringList(String prefKey, String propKey, List<String> defaultValue) {
		store.setDefault(prefKey, parseStringListProperty(propKey, defaultValue));
	}
	...
	private String parseDateProperty(String key, Date defaultValue) {
		String strict = getPropertyValue(key);
		Date date = null;
		if (strict != null) {
			try {
	...
	protected final String parseStringProperty(String key, String defaultValue) {
		String strict = getPropertyValue(key);
		if (strict != null) {
			return strict;
		}
	...
	private String parseStringListProperty(String key, List<String> defaultValue) {
		String strict = getPropertyValue(key);
		if (strict != null) {
			return strict;
		}
