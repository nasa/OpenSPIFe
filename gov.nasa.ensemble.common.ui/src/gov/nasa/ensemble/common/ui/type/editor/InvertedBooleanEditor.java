...
public class InvertedBooleanEditor extends AbstractTypeEditor<Boolean> {

	private final Composite parent;
	private final Button button;

	public InvertedBooleanEditor(Composite parent) {
		super(Boolean.class);
		this.parent = parent;
		button = createButton();
	}
	...
	private Button createButton() {
		...
		button.addSelectionListener(new SelectionListener() {
			...
			private void updateEditor() {
				InvertedBooleanEditor.super.setObject(!Boolean.valueOf(button.getSelection()));
			}
		});
		return button;
	}
