...
public class AdvisorMemberFactory implements IPlanElementMemberFactory {
	...
	public EMember createMember(EClass eClass) {
		if (eClass == PlanPackage.Literals.EACTIVITY
			...
			return AdvisorFactory.eINSTANCE.createActivityAdvisorMember();
		}
		if (eClass == PlanPackage.Literals.EPLAN) {
			return AdvisorFactory.eINSTANCE.createPlanAdvisorMember();
		}
		return null;
	}
