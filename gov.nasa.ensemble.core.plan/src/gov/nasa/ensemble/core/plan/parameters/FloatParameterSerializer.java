...
public class FloatParameterSerializer implements IParameterSerializer<Object> {
	...
	public String getFloatHibernateString(Float javaObject) {
		if (javaObject == null) {
			return null;
		}
	...
	public Float getJavaObject(String hibernateString) {
		...
		try {
			return Float.valueOf(hibernateString);
