...
public class TestPatchWithAllFeatureTypesSerializedWithoutID extends AbstractPatchTestWithAllFeatureTypes {
	...
	protected SomeTestClass createSomeTestClass() {
		return PatchTestFactory.eINSTANCE.createSomeTestClass();
	}
