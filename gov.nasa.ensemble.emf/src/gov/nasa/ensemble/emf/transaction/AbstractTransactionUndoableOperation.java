...
public abstract class AbstractTransactionUndoableOperation extends AbstractEnsembleUndoableOperation implements IJobOperation {

	public AbstractTransactionUndoableOperation(String label) {
		super(label);
	}
