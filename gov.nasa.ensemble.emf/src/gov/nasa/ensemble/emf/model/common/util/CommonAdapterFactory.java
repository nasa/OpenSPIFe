...
public class CommonAdapterFactory extends AdapterFactoryImpl {
	...
	protected CommonSwitch<Adapter> modelSwitch =
		new CommonSwitch<Adapter>() {
			...
			@Override
			public Adapter caseObjectFeature(ObjectFeature object) {
				return createObjectFeatureAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link gov.nasa.ensemble.emf.model.common.ObjectFeature <em>Object Feature</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createObjectFeatureAdapter() {
		return null;
	}
