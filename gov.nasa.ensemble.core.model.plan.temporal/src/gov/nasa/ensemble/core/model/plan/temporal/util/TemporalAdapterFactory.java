...
public class TemporalAdapterFactory extends AdapterFactoryImpl {
	...
	protected TemporalSwitch<Adapter> modelSwitch =
		new TemporalSwitch<Adapter>() {
			@Override
			public Adapter caseTemporalMember(TemporalMember object) {
				return createTemporalMemberAdapter();
			}
			@Override
			public Adapter casePlanTemporalMember(PlanTemporalMember object) {
				return createPlanTemporalMemberAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link gov.nasa.ensemble.core.model.plan.temporal.TemporalMember <em>Member</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link gov.nasa.ensemble.core.model.plan.temporal.PlanTemporalMember <em>Plan Temporal Member</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
