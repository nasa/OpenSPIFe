...
public class PlanTimelinePreferenceInitializer extends PropertyPreferenceInitializer {

	public PlanTimelinePreferenceInitializer() {
		super(TimelinePlugin.getDefault().getPreferenceStore());
	}
	
	@Override
	public void initializeDefaultPreferences() {
		setBoolean(TimelineConstants.VIOLATIONS_VISIBLE, true);
		setBoolean(PlanTimelineConstants.PLAN_CONSTRAINTS_VISIBLE, true);
	}
