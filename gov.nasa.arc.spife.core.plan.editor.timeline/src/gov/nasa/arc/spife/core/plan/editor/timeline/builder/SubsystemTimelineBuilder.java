...
import gov.nasa.arc.spife.core.plan.editor.timeline.models.ActivityDefCategoryGroupingTimelineContentProvider;
...
public class SubsystemTimelineBuilder extends AbstractPlanTimelineBuilder {
	...
	public TimelineViewer build(PlanTimeline timeline, Section section) {
		...
		PlanTimelineContentProvider defaultContentProvider = new ActivityDefCategoryGroupingTimelineContentProvider(plan);
