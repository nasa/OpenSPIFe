...
public class TimelinePlanClipboardCutOperation extends PlanClipboardCutOperation implements IDisplayOperation {
	
	public TimelinePlanClipboardCutOperation(ITransferable transferable, IStructureModifier modifier) {
