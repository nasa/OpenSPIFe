...
/**
 * This is the item provider adapter for a {@link gov.nasa.ensemble.core.model.plan.EMember} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EMemberItemProvider
	 ...
	 * @generated
	 */
	public EMemberItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((EMember)object).getKey();
		return label == null || label.length() == 0 ?
			getString("_UI_EMember_type") :
			getString("_UI_EMember_type") + " " + label;
	}
	...
	protected ItemPropertyDescriptor createItemPropertyDescriptor(
		...
		String[] filterFlags)
	{
		return new EMemberItemPropertyDescriptor(
			adapterFactory,
			resourceLocator,
			intern(displayName),
			intern(description),
