...
/**
 * This is the item provider adapter for a {@link gov.nasa.arc.spife.timeline.model.Section} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SectionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TimelinePackage.Literals.SECTION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addAlignmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Section_alignment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Section_alignment_feature", "_UI_Section_type"),
				 TimelinePackage.Literals.SECTION__ALIGNMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Section.class)) {
			case TimelinePackage.SECTION__NAME:
			case TimelinePackage.SECTION__ALIGNMENT:
