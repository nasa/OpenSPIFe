 ...
 * <ul>
 *   <li>{@link gov.nasa.arc.spife.timeline.model.impl.TimelineContentImpl#getRowHeight <em>Row Height</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TimelineContentImpl extends SectionImpl implements TimelineContent {
	/**
	...
	protected EClass eStaticClass() {
		return TimelinePackage.Literals.TIMELINE_CONTENT;
	}
	...
	public void setRowHeight(Integer newRowHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TimelinePackage.TIMELINE_CONTENT__ROW_HEIGHT, oldRowHeight, rowHeight));
	}
