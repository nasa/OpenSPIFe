...
public class DeleteTemporalBoundOperation extends AbstractTransactionUndoableOperation {

	private final PeriodicTemporalConstraint constraint;

	public DeleteTemporalBoundOperation(PeriodicTemporalConstraint temporalBound) {
	...
	public String toString() {
		StringBuilder builder = new StringBuilder(DeleteTemporalBoundOperation.class.getSimpleName());
		builder.append(":");
