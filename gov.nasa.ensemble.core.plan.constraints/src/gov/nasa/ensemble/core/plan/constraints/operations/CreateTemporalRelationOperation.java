...
public class CreateTemporalRelationOperation extends AbstractTransactionUndoableOperation {

	private final BinaryTemporalConstraint relation;

	public CreateTemporalRelationOperation(BinaryTemporalConstraint constraint) {
	...
	public String toString() {
		StringBuilder builder = new StringBuilder(CreateTemporalRelationOperation.class.getSimpleName());
		builder.append(":");
